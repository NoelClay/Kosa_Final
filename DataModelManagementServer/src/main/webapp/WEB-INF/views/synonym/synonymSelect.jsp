            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="/dms/standardData/page" class="menu-link">
                        ...
                        <div data-i18n="Basic">표준 데이터 조회</div>
                    </a>
                </li>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <!-- Title -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted bold"> 데이터 표준 관리 / </span> 동의어 조회 </h4>
                    <!-- Title -->
                    <!-- 여기에 내용 넣기 -->
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="left-side">
                                            <div class="card">
                                                <div class="row">
                                                    <div class="col-md">
                                                        <h5 class="card-header">동의어 검색</h5>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="ps ps--active-y ps--active-x" id="both-scrollbars-example">
                                                    <div class="table-responsive text-nowrap">
                                                        <table id="table" class="table accordion mt-3">
                                                            <thead>
                                                            <tr>
                                                                <th></th>
                                                                <th>번호</th>
...
<script src="/js/synonym/synonymSearch.js"></script>
