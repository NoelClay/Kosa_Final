        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Title -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-bold"> 도메인 / </span> 일괄등록 </h4>
                    <!-- Title -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            <div class="card">
                                ...
                                <div class="card-body demo-vertical-spacing demo-only-element">
                                    <form id="fileUploadForm" method="post" action="/dms/bulk-domain/display"
                                    ...
                                    <div class="col-sm-5 mb-3">
                                        <button type="button" class="btn btn-secondary btn-lg btn-md" id="downloadExcelFormOfDomainBtn">서식다운로드
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="load">
                            <c:if test="${not empty domainExcelDataList}">
                                <!-- Vertical & Horizontal Scrollbars -->
                                <div class="col-12 mb-3">
                                    <div class="card overflow-hidden" style="height: 500px">
                                        <h5 class="card-header">도메인 목록(등록 가능)</h5>
                                        ...
                                        <div class="table-responsive text-nowrap">
                                            <div class="card-body both-scrollbars-example">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                    <c:forEach items="${domainExcelDataList}" var="domainExcelData"
                                                               varStatus="status">
                                                        <c:if test="${fn:contains(domainExcelData.reason, '!Y!')}">
                                                            <tr>
                                                                <th scope="row">${status.index + 2}</th>
                                                                <td><input class="form-check-input" type="checkbox"
                                                                           name="availableRow" value="Y"
                                                                           checked="checked"></td>
                                                                <input type="hidden" name="stdAreaId"
                                                                       value="${domainExcelData.stdAreaId}">
                                                                <td name="reason">Y</td>
                                                                <td name="keyDomainName">${domainExcelData.keyDomainName}</td>
                                                                <td name="domainName">${domainExcelData.domainName}</td>
                                                                <td name="domainTypeCode">${domainExcelData.domainTypeCode}</td>
                                                                <td name="domainGroupName">${domainExcelData.domainGroupName}</td>
                                                                <input type="hidden" name="domainGroupId"
                                                                       id="domainGroupId"
                                                                       value="${domainExcelData.domainGroupId}">
                                                                <td name="dataTypeCode">${domainExcelData.dataTypeCode}</td>
                                                                <td name="dataLength">${domainExcelData.dataLength}</td>
                                                                <td name="dataScale">${domainExcelData.dataScale}</td>
                                                                <td name="dataMin">${domainExcelData.dataMin}</td>
                                                                <td name="dataMax">${domainExcelData.dataMax}</td>
                                                                <td name="domainDescription">${domainExcelData.domainDescription}</td>
                                                            </tr>
                                                        </c:if>
                                                    </c:forEach>
                                                    </tbody>
                                ...
                                <div class="col-12">
                                    <div class="card overflow-hidden" style="height: 500px">
                                        <h5 class="card-header">도메인 목록(등록 불가능)</h5>
                                        ...
                                        <div class="table-responsive text-nowrap">
                                            <div class="card-body both-scrollbars-example">
                                                <table class="table">
                                                    ...
                                                    <c:forEach items="${domainExcelDataList}" var="domainExcelData"
                                                               varStatus="status">
                                                        <c:if test="${not fn:contains(domainExcelData.reason, '!Y!')}">
                                                            <tr>
                                                                <th scope="row">${status.index + 2}</th>
                                                                <td><input class="form-check-input" type="checkbox"
                                                                ...
                                                                <input type="hidden" name="stdAreaId"
                                                                       value="${domainExcelData.stdAreaId}">
                                                                <td name="reason">
                                                                  <c:forEach items="${domainExcelData.reason}"
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title fw-bold" id="exampleModalLabel4"><span
                                            class="text-muted fw-bold">도메인 /</span> 등록 완료 목록</h5>
                                </div>
...
<script src="/js/bulk/domain.js"></script>
