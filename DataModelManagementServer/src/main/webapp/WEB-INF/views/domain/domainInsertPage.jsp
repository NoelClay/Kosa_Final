        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Title -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted bold"> 도메인 / </span> 등록 </h4>
                    <!-- Title -->
                    ...
                    <div class="col-md-16">
                        <div class="card mb-5">
                            <h5 class="card-header">도메인 등록</h5>
                            <div class="card-body">
                                <form id="domainForm">
                                    <div class="col-sm-16 mb-3 form-floating">
                                        <input type="text" class="form-control" id="keyDomName" name="keyDomName"
                                               placeholder="입력..." onkeyup="characterCheck(this)"
                                           	   style="text-transform: uppercase"
                                               onkeydown="characterCheck(this)" aria-describedby="keyDomNameHelp">
                                    ...
                                    <div class="col-sm-16 mb-3">
                                        ...
                                        <select class="form-select color-dropdown" id="dataTypeCode"
                                                name="dataTypeCode">
                                            <option value="" selected disabled>논리 데이터타입</option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5 mb-4 form-floating">
                                            ...
                                            <label for="dataMin">&nbsp;&nbsp;&nbsp;&nbsp;데이터 범위(최소)</label>
                                        </div>
                                        <div class="col-sm-1"
                                             style="line-height: 6; text-align: center; font-weight: bold;">~
                                        </div>
                                        <div class="col-sm-6 mb-3 form-floating">
                                            ...
                                            <label for="dataMax">&nbsp;&nbsp;&nbsp;&nbsp;데이터 범위(최대)</label>
                                        </div>
                                    </div>
...
<!-- Content -->
<div id="alertContainer" style="position: fixed; bottom: 10px; left: 50%; transform: translateX(-50%);"></div>
...
<script src="/js/domain/domain-insert-validation.js"></script>
