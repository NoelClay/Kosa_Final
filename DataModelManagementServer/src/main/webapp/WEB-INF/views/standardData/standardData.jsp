        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <!-- Title -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-bold"> 데이터 표준 관리 / </span> 표준 데이터 조회 </h4>
                    <!-- Title -->
                    ...
                    <div class="card ">
                        <div class="row">
                            <div class="col-md">
                                <h5 class="card-header" style="padding-right: 0rem;">표준 데이터 조건 검색</h5>
                            </div>
                            <div class="col-md mt-3 sm-1" style="padding-right: 0rem;">
                                <div class="input-group" style="width: 500px;">
                                    <input class="form-control" type="search" placeholder="검색하기.."
                                    	   style="text-transform: uppercase"
                                           aria-label="Search" id="conditionSearch">
                                    <label style="cursor: pointer; background-color: #696cff; border-color: #696cff; color: white;" class="input-group-text" id="searchLabel"
                                           for="conditionSearch">검색</label>
                                </div>
                             </div>
                             <div class="col-md mt-3 sm-1">
                                <div class="input-group">
				                     <label class="input-group-text" 
				                             id="saveCollectionToExcel"
				                             style="cursor: pointer; background-color: #8592a3; border-color: #8592a3; color: white;">출력
				                     </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body  both-scrollbars-example">
                            ...
                            <div class="row mt-3">
                                <div class="table-responsive overflow-auto" style="height: 480px">
                                    ...
                                    <!-- 버튼 -->
                                    <div class="card-body" id="saveCollectionToExcelArea">
                                    </div>
                                    <!-- 버튼 -->
                                </div>
                            </div>
                                        ...
                                        <div class="col mb-3">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="stdModalWordLogNm" class="form-control"
                                                       ...
                                                       onkeydown="characterCheck(this)" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <form id="editDomainForm">
                                        ...
                                        <div class="col-sm-16 mb-3 form-floating">
                                            <input type="text" class="form-control" id="stdModalkeyDomName"
                                                   name="keyDomName"
                                                   placeholder="입력..." onkeyup="characterCheck(this)" onkeydown="characterCheck(this)" aria-describedby="keyDomNameHelp" readonly>
                                        ...
                                        <div class="col-sm-16 mb-3">
                                            ...
                                            <select class="form-select color-dropdown" id="stdModalDomGroupId" name="domGroupId" disabled>
                                            </select>
