        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-bold"> 단어 / </span> 등록 </h4>


                    <!-- Content -->
                    <div class="col-md-16">
                        <div class="card mb-5">
                        	<h5 class="card-header">표준단어 등록</h5>
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="col-sm-16 mb-3 form-floating">
                                            <input type="text" class="form-control" id="dicLogNm"
                                                   ...
                                                   placeholder="입력..." onkeyup="characterCheckForLogicalName(this)"
                                                   onkeydown="characterCheckForLogicalName(this)">
                                            <label for="dicLogNm">논리명</label>
                                        </div>
                                        ...
                                        <div class="col-sm-16 mb-3 form-floating">
                                            ...
                                            <label for="dicPhyNm">물리명</label>
                                        </div>

                                        <div class="col-sm-2 mb-3">
                                            <button type="button" class="btn btn-primary"
                                                    id="checkDuplicateWordButton">중복 확인
                                            </button>
                                        </div>

                                        <div class="col-sm-16 mb-3 form-floating">
                                            <input type="text" class="form-control" id="dicPhyFllNm"
                                            	   style="text-transform: uppercase"
                                                   placeholder="입력...">
                                            <label for="dicPhyFllNm">영문풀네임</label>
                                        </div>

                                        <div class="col-sm-16 mb-3 form-floating">
                                            <input type="text" class="form-control" id="dicDesc"
                                                   placeholder="입력...">
                                            <label for="dicDesc">설 명</label>
                                        </div>

                                        <div class="form-check" style="display: flex;">
                                            <input class="form-check-input" type="checkbox" value="" id="entClssYn"
                                                   unChecked/>
                                            <label class="form-check-label" for="entClssYn"> 엔티티 </label>
                                        </div>

                                        <div class="form-check" style="display: flex;">
                                            <input class="form-check-input" type="checkbox" value="" id="attrClssYn"
                                                   unChecked/>
                                            <label class="form-check-label" for="attrClssYn"> 속성 </label>
                                        </div>


                                        <div class="row justify-content-center">
                                            <div class="col-sm-1 text-center mb-3"> <!-- 중앙 정렬, 간격 추가 -->
                                                <button type="button" class="btn btn-primary" id="confirmButton"
                                                        disabled>등록
                                                </button>
                                            </div>
                                            <div class="col-sm-1 text-center"> <!-- 중앙 정렬 -->
...
<script src="/js/word/word-insert-validation.js" defer></script>
