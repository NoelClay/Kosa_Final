        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Title -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-bold"> 프로젝트 관리 / </span> 등록 </h4>
                    <!-- Title -->
                        ...
                        <div class="col-xxl">
                            <div class="card mb-4">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0">프로젝트 등록</h5>
                                </div>
                                <div class="card-body">
                                    <form>
                                        <div class="row mb-3">
                                            <div class="input-group">
                                                <label for="stdAreaNm" class="input-group-text">프로젝트명(*)</label>
                                                <input type="text" class="form-control" id="stdAreaNm"
                                                       placeholder="프로젝트명" aria-describedby="floatingInputHelp">
                                                <label style="cursor:pointer; background-color: #696cff; border-color: #696cff; color: white;" class="input-group-text"
                                                       id="validationCheckLabel" for="stdAreaNm">중복 확인</label>
                                            </div>
                                        </div>
                                        <div class="row mb-3 ">
                                            <div class="input-group">
                                                <label for="stdAreaDesc" class="input-group-text">프로젝트 설명</label>
                                                <input type="text" class="form-control" id="stdAreaDesc"
                                                       placeholder="프로젝트 설명">
                                            </div>
                                        </div>
