        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Title -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-bold"> 프로젝트 관리 / </span> 관리 </h4>
                    <!-- Title -->
                    ...
                    <div class="row">
                                    ...
                                    <div class="table-responsive text-nowrap">
                                        <table class="table table-hover">
                                            ...
                                            <c:forEach var="std" items="${sessionScope.stdList}">
                                                <tr>
                                                    <td>${std.stdAreaNm}</td>
                                                    <td>${std.stdAreaDesc}</td>
                                                    <td class="text-end">
                                                        <!-- 수정 버튼 -->
                                                        <button type="button" class="btn btn-primary"
                                                                onclick="handleEditButtonClick(this)">수정
                                                        </button>
                                                        <!-- 삭제 버튼 -->
                                                        <button type="button" class="btn btn-secondary"
                                                                onclick="handleDeleteButtonClick(this)">삭제
                                                        </button>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="deleteModalTitle">삭제 확인</h5>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger" id="deleteConfirmButton">삭제
                                        </button>
                        ...
                        <div class="modal fade" id="modalCenter" tabindex="-1" style="display: none;"
                             aria-hidden="true" data-bs-target="static">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalCenterTitle">수정하기</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col mb-3">
                                                <div class="input-group">
                                                    <label for="modalCategory" class="input-group-text">프로젝트명 &nbsp;&nbsp;&nbsp; </label>
                                                    <input type="text" id="modalCategory" class="form-control"
                                                           placeholder="입력...">
                                                    <label style="cursor: pointer;" class="input-group-text"
                                                           for="modalCategory" id="validationCheckLabel">중복확인</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row g-2">
                                            <div class="col mb-0">
                                                <div class="input-group">
                                                    <label for="modalDescription" class="input-group-text">프로젝트
                                                        설명</label>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary" id="confirmButton">수정</button>
                                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                                            닫기
                                        </button>
                                    </div>
...
<script src="/js/standardArea/standardArea-update.js"></script>
<script src="/js/standardArea/standardArea-delete.js"></script>
