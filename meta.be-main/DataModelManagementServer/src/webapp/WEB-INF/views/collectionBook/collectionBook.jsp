        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Title -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-bold"> 데이터 표준 관리 / </span> 표준 데이터 출력 </h4>
                    <!-- Title -->
                            ...
                            <div class="card">
                                <div class="row">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md">
                                                <h5 class="form-check form-check-inline mt-3">표준 데이터 선택 :</h5>
                                            </div>
                                            <div class="col-md">
...
<script src="/js/collectionBook/collectionBook.js"></script>
