        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Title -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-bold"> 권한 / </span> 개인별 권한 </h4>
                    <!-- Title -->
	                ...
	                <div class="col-xxl">
		              ...
		              <div class="row align-items-center" style="padding-right: 24px;">
		    				<div class="col">
		        				<h5 class="card-header mb-0">사용자 목록</h5>
		    				</div>
		    				<div class="col-auto">
		        				<button class="btn btn-secondary btn-lg" type="button" id="insertNewIndividualBtn">신규 등록</button>
		   					</div>
						</div>
						<div class="row">
			                <div class="col-md mt-3">
		                         <div class="input-group">
		                          <select id="searchCondition" class="form-select color-dropdown" style="margin-left: 157px; margin-right: -21px; border-radius: 0.375rem;">
		                              ...
		                              <option value="INACTIVE">미사용자</option>
		                     ...
		                     <div class="col-md mt-3 me-4">
		                         <div class="input-group">
		                             <input class="form-control" type="search" placeholder="검색하기.."
		                                    aria-label="Search" id="searchForUser">
		                             <label style="cursor: pointer;" class="input-group-text" id="searchForUserBtn"
		                                    for="searchForUserBtn">검색</label>
		                         </div>
		                     </div>
		                 </div>
		                <div class="table-responsive text-nowrap">
			              ...
			              <table class="table table-bordered table-hover">
		                      ...
		                      <tbody id="allIndividualUserTbody">
		                        <c:forEach items="${individualUserDtoList}" var="individualUserDto" varStatus="status">
		                          <tr id="individualUserRow_${individualUserDto.usrId}">
		                            <td scope="row">${status.index + 1}</td>
		                            <td name="usrId">${individualUserDto.usrId}</td>
		                            <td name="usrName">${individualUserDto.usrName}</td>
		                            <td name="usrYn">${individualUserDto.useYn}</td>
		                            <!--<td name="groupName">${individualUserDto.groupName}</td>  -->
		                          </tr>
		                          <tr id="individualUserRow_detail_${individualUserDto.usrId}" style="display:none;">
		                          	<td colspan="4" id="detail_content_${individualUserDto.usrId}" style="display:none;">
					                    <div class="card-header d-flex align-items-center justify-content-between">
						                    <div class="col">
						                      <h5 class="mb-0">사용자 정보</h5>
					                        </div>
						                    <div class="col-auto">
						        			  <button class="btn btn-secondary btn-lg" type="button" id="updateUserBtn_${individualUserDto.usrId}">수정</button>
						   					</div>
					                    </div>
					                    <div class="card-body">
					                      <form>
					                      <div class="row mb-3">
					                          ...
					                          <div class="col-sm-10">
					                            <div class="input-group input-group-merge">
					                              <input
					                                type="text"
					                                id="basic-icon-default-email_${individualUserDto.usrId}"
					                                class="form-control"
					                                placeholder="이메일"
					                                aria-label="john.doe"
					                        ...
					                        <!-- <div class="row mb-3">
					                          <label class="col-sm-2 col-form-label" for="basic-icon-default-password">비밀번호</label>
					                          <div class="col-sm-10">
					                            <div class="input-group input-group-merge">
					                              <input
					                                type="password"
					                                id="basic-icon-default-password_${individualUserDto.usrId}"
					                                class="form-control"
					                                placeholder="비밀번호"
					                                aria-label="john.doe"
					                                aria-describedby="toggle-password-icon_${individualUserDto.usrId}"
					                                readonly
					                              />
					                              <button class="input-group-text" id="toggle-password-icon_${individualUserDto.usrId}" type="button">
											        <i class="bi bi-eye-slash" id="eyeIcon_${individualUserDto.usrId}"></i>
											      </button>
					                            </div>
					                          </div>
					                        </div>
					                        <div class="row mb-3">
					                          <label class="col-sm-2 col-form-label" for="basic-icon-default-useYn">사용유무</label>
					                          <div class="col-sm-10">
					                            <div class="input-group input-group-merge">
					                              <input
					                                type="text"
					                                id="basic-icon-default-useYn_${individualUserDto.usrId}"
		              ...
		              <div class="col-xxl">
			              <div class="card">
			                <div class="row align-items-center" style="padding-right: 24px;">
			    				<div class="col">
			        				<h5 class="card-header mb-0">개인별 권한</h5>
			    				</div>
			    				<div class="col-auto">
				              ...
				              <table class="table table-hover">
			                      ...
			                      <tbody id="IndividualAuthorization">
			                      </tbody>
			                    </table>
				              </div>
			              </div>
                ...
                <!-- 신규 등록 모달 -->
                    <div class="modal fade" id="insertNewIndividualModal" tabindex="-1" style="display: none;" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="insertNewIndividualTitle">신규 등록</h5>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-3">
                                            <div class="input-group">
                                                <label for="userName" class="input-group-text" style="width: 100px;">사용자명
                                                    &nbsp;&nbsp;&nbsp; </label>
                                    ...
                                    <div class="row">
                                        <div class="col mb-3">
                                            <div class="input-group">
                                                <label for="userId" class="input-group-text" style="width: 100px;">아이디
                                                    &nbsp;&nbsp;&nbsp; </label>
                                                <input type="text" id="userId" class="form-control"
                                                       placeholder="아이디">
                                                <label style="cursor: pointer;" class="input-group-text"
                                                       for="stdModalWordPhyNm" id="userIdValidation">중복확인</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col mb-3">
                                            <div class="input-group">
                                                <label for="userPassword" class="input-group-text" style="width: 100px;">비밀번호</label>
                                                <input type="password" id="userPassword" class="form-control"
                                                       placeholder="비밀번호">
                                            	<button class="input-group-text" id="toggle-password-icon-userPassword" type="button">
										        	<i class="bi bi-eye-slash" id="eyeIcon-userPassword"></i>
										        </button>           
                                            </div>	                              	
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col mb-3">
                                            <div class="input-group">
	                                            <select id="useYn" class="form-select color-dropdown">
	                                                <option value="" selected disabled>사용 유무</option>
                                    ...
                                    <div class="row">
                                    	<h5 class="card-header mb-0">개인별 권한</h5>
							              ...
							              <table class="table table-hover">
						                      ...
						                      <tbody id="newIndividualAuthorization">
					                      	  </tbody>
					                      </table>
							              </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" id="insertNewSubjAreaAuthBtn">등록</button>
                    ...
                    <!-- 사용자 정보 수정 모달 -->
                    <div class="modal fade" id="updateIndividualInfoModal" tabindex="-1" style="display: none;" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="updateIndividualInfo">사용자 정보 수정</h5>
									<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="refreshPage()"></button>
                                </div>
                                <div class="modal-body">
                                <input type="text" id="targetIdForUpdate" hidden/>
                                	<div class="row">
                                        <div class="col mb-3">
                                            <div class="input-group">
                                                <label for="currentEmail" class="input-group-text" style="width: 140px;">현재 이메일</label>
                                    ...
                                    <div class="row">
                                        <div class="col mb-3">
                                            <div class="input-group">
                                                <label for="updateEmail" class="input-group-text" style="width: 140px;">새 이메일</label>
                                    ...
                                    <div class="row">
                                        <div class="col mb-3">
                                            <div class="input-group">
	                                            <select id="updateUseYn" class="form-select color-dropdown">
	                                                <option value="" selected disabled>사용유무</option>
	                                                <option value="Y">Y</option>
	                                                <option value="N">N</option>
	                                            </select>
                                            </div>
...
<script src="/js/authorization/individual.js"></script>
